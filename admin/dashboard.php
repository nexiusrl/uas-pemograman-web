...
<div class="row">
  ...
  <div class="row g-3 mb-4">
   ...
   "total_unit"
        ...
        <div class="progress-bar <?php echo $bar_color; ?>" role="progressbar" style="width: <?php echo $pct; ?>%;" aria-valuenow="<?php echo $pct; ?>" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <div class="d-flex justify-content-between mt-2" style="font-size: 0.75rem; color: #888;">
        <span>Ketersediaan</span>
        <span class="fw-semibold"><?php echo $pct; ?>%</span>
        </div>
      </div>
    </div>
    </div>
